...
<template>
    <div class="profile" v-if="props.currentPlayer">
        ...
        <div class="health">
            ...
            <div class="bar">
                <div class="bar-fill"
                    :style="{ width: `${(props.currentPlayer.hp / props.currentPlayer.max_hp) * 100}%` }">
                </div>
                <span class="value">{{ props.currentPlayer.hp }} / {{ props.currentPlayer.max_hp }}</span>
            </div>
        </div>
        ...
        <div class="stats">
            ...
            <div class="stat">
                ...
                <span class="value">{{ object2name(props.currentPlayer.current_weapon) }}</span>
            </div>
            <div class="stat">
                <span class="label">Armor</span>
                <span class="value">{{ object2name(props.currentPlayer.current_armor) }}</span>
            </div>
        </div>
    </div>
</template>
